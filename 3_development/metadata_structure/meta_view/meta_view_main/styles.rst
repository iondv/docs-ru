...
Список поддерживаемых функций можно посмотреть `\ здесь </3_development/metadata_structure/meta_class/meta_class_attribute/attr_formula.rst>`_ . Настройка задается в общей части меты представления списка и выглядит следующим образом:
