...
.. toctree::
   ...
   meta_wf_files/wf_security
   meta_wf_files/wf_status
   meta_wf_files/wf_transitions
...
.. list-table::
   ...
   * - ``"states"``
     - :doc:`Список статусов <meta_wf_files/wf_status>`
     - Список статусов бизнес-процесса.
   * - ``"transitions"``
     - :doc:`Переходы <meta_wf_files/wf_transitions>`
